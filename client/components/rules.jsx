	...
	render() {
		return (
			<div id="rules" className="well text-center">
				<h3>How To Play</h3>
				<p>
					Well Hillibilly do da! Come along boys and girls!<br /> Help your friend Sasha collect all the grains on her daddy's farm land!<br /> 
					Can you find the right number of grains?<br />
				</p>
